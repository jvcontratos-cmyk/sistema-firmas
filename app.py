...
COORDENADAS_MAESTRAS = {
    ...
    "Servicios": {
        5: [(330, 170)], # Ajusta estos números según veas el cuadro rojo
        7: [(363, 370)], # Ejemplo: si esta página es un anexo de datos
        8: [(300, 170)]  # Ejemplo: si esta es la de seguridad
    },
}
