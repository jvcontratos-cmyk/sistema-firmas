...
COORDENADAS_MAESTRAS = {
    ...
    "Servicios": {
        5: [(310, 175], # Ajusta estos números según veas el cuadro rojo
        7: [(370, 365)], # Ejemplo: si esta página es un anexo de datos
        8: [(270, 190)]  # Ejemplo: si esta es la de seguridad
    },
}
